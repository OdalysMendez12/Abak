                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <button class="btn btn-danger" style="margin-left: 30%;"><a target="_self" href="../acciones/eliminarMarca.php?id_marca=<?php echo $fila['id_marca'] ?>"><i class="fas fa-trash text-white"></i></a></button>
                            </td>
                                </tr>
