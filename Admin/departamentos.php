                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger" style="margin-left: 30%;"><a target="_self" href="../acciones/eliminarDep.php?id=<?php echo $fila['id'] ?>"><i class="fas fa-trash text-white"></i></a></button>
                                </td>
                                </tr>
