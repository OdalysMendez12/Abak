            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container">
                        <div class="col-mb-6">
                            <div class="col-9">
                                <h1 class="m-2">Sistemas Operativos</h1>
                            </div>
                            <div class="box">
                <div class="box-header">
                <button class="btn btn-primary" data-toggle="modal" data-target="#Crearso">Crear nuevo</button>
                </div>
                <br>
                                ...
                                <div class="modal fade" id="Editarso<?php echo $contador ?>">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="../acciones/editarSO.php" method="POST">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            <h2>Nombre:</h2>
                                                            <input type="text" class="form-control input-lg" name="nombre_so" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                <input type="submit" name="Enviar" value="Editar Sistema" class="btn btn-primary" />
...
<div class="modal fade" id="Crearso">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="../acciones/regSO.php" method="POST">
                <div class="modal-body">
                    <div class="box-body">
                        <div class="form-group">
                            <h2>Nombre Sistema Operativo:</h2>
                            <input type="text" class="form-control input-lg" name="nombre_so" required="">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                <input type="submit" name="Enviar" value="Insertar Sistema" class="btn btn-primary" />
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                </div>
            </form>
        </div>
