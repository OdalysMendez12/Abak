        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div>
                    ...
                    <div class="row">
                        <form action="../acciones/regTicket.php " method="POST" enctype="multipart/form-data">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <fieldset class="form-group">
                                    ...
                                    <select id="cats_id" name="fk_estatus" class="form-control">
                                        <?php
                                        include('../conec.php');
                                        $consultaestatus = "SELECT * FROM estatus_ticket WHERE estatus = 'nuevo'";
                            ...
                            <div class="col-lg-6">
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" name="fecha_reporte" class="form-control" value="<?php echo date('Y-m-d H:i:s'); ?>" readonly>
                                </fieldset>
                            </div>
