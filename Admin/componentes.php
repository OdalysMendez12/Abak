                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger" style="margin-left: 20%;"><a target="_self" href="../acciones/eliminarCompo.php?id=<?php echo $fila['id'] ?>"><i class="fas fa-trash text-white"></i></a></button>
                                </td>
                                </tr>
