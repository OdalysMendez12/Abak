...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#CrearEst">Crear nuevo</button>
                </div>
                <br>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger" style="margin-left: 30%;"><a target="_self" href="../acciones/eliminarEstados.php?id=<?php echo $fila['id'] ?>"><i class="fas fa-trash text-white"></i></a></button>
                                </td>
                                </tr>
                                <div class="modal fade" id="EditarEst<?php echo $contador ?>">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="../acciones/editarEstados.php" method="POST">
                                                ...
                                                <input type="submit" name="Enviar" value="Editar estado" class="btn btn-primary" />
...
<div class="modal fade" id="CrearEst">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="../acciones/regEstados.php" method="POST">
                <div class="modal-body">
                    <div class="box-body">
                        <div class="form-group">
                            <h2>Nombre Estado:</h2>
                ...
                <div class="modal-footer">
                <input type="submit" name="Enviar" value="Insertar estado" class="btn btn-primary" />
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                </div>
            </form>
        </div>
